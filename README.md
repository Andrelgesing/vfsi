...
If you use uFSI in your research, please cite

A. Gesing, D. Platz, U. Schmid: uFSI: a viscous fluid-MEMS structure interaction python library
...
@article{gesing2024vfimems,
  ...
  title={{uFSI: a viscous fluid-MEMS structure interaction python library}},
  Year={2026},
  Month=feb
}
```
