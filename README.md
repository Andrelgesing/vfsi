...
If you use muFSI in your research, please cite

A. Gesing, D. Platz, U. Schmid: muFSI: a viscous fluid-MEMS structure interaction python library

BibTex:

```
@article{gesing2026vfimems,
  author={Gesing, Andre and Platz, Daniel and Schimid, Ulrich},
  title={{muFSI: a viscous fluid-MEMS structure interaction python library}},
  Year={2026},
  Month=feb
}
```
